<?php /* Smarty version 2.6.22, created on 2011-11-10 13:57:59
...
$(document).ready(function(){
	...
	tr=$("#tab1").find("tr");
	for(var z=1;z<=trlength-5;z++)
	{
		tr.each(function(i){
			if(i==2)
			{
				sum1+=parseInt($(this).children("td").eq(z+1).html(),10);
			}
			else if(i==3||i==4)
			{
			...
			{
				$(this).children("td").eq(z).html(sum1);
			}
			else if(i==8)
			{
				$(this).children("td").eq(z).html(sum2);
			}
			else if(i==13)
			{
				$(this).children("td").eq(z).html(sum3);
			}
			else if(i==15)
			{
				$(this).children("td").eq(z).html(sum1+sum2+sum3+sum4);
			}
		});
		sum1=0;
		sum2=0;
...
">
	<tr align="center" style="background-color:#0099FF;">
	    <td colspan="2">Auto Show Sales Leads By Model (data.2011)</td>
...
?>
	...
	<tr>
	  <td colspan="2" align="center">2011Total</td>
	  <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['list1'][0]) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
...
?>
	...
	<input type="button" value="导出为Excel格式" name="but" onclick="location.href='a.php'">
</div>
</body>
</html>